...
impl Blob for SimpleBlob {
    ...
    fn get_predicted_bbox_readonly(&self) -> Rect { SimpleBlob::get_predicted_bbox_readonly(self) }
    fn get_predicted_position_readonly(&self) -> (f32, f32) { self.tracker.get_predicted_position() }
